...
<head>
    ...
    <style>
        ...
        button { width: 100%; padding: 10px; background-color:rgb(255, 48, 65); color: white; border: none; border-radius: 4px; cursor: pointer; }
        button:hover { background-color:rgb(243, 42, 42); }
    </style>
</head>
<body>
...
<div class="container">
    ...
    <?php if (isset($data_found) && $data_found): ?>
        ...
        <form method="POST" action="submit_revisi2.php">
            ...
            <select id="area_sales" name="area_sales" required>
                <option value="JB" <?php echo ($data['area_sales'] == 'JT') ? 'selected' : ''; ?>>JT</option>
                <option value="JR" <?php echo ($data['area_sales'] == 'DK') ? 'selected' : ''; ?>>DK</option>
                <option value="JR" <?php echo ($data['area_sales'] == 'LP') ? 'selected' : ''; ?>>LP</option>
            </select>
